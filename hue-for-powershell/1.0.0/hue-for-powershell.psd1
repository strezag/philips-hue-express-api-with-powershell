#
# Module manifest for module 'HueForPowerShell'
#
...
@{
    ...
    RootModule = 'hue-for-powershell.psm1'
    ...
    Copyright = '(c) 2021 Gabriel Streza. All rights reserved.'
    
    # Description of the functionality provided by this module
    Description = 'A wrapper around a locally-run express-based NodeJS application to toggle Philips Hue light states.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/strezag/'
